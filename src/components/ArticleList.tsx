...
import { Content } from '../../app/tech/articles/[origin]';
                        ...
                        <View key={article.id} className="pb-4">
                            ...
                            <View className="space-y-4 px-0">
                                <Image
                                    ...
                                    alt=""
                                />
                                <Text className="font-body text-base leading-relaxed text-slate-900 dark:text-slate-100">
                                    {article.title}
                                </Text>
                                <Link
                                    href={{
                                        pathname: `/article`,
                                        params: { url: base64.encode(article.link) },
                                    }}
                                    asChild
                                >
                                    <TouchableOpacity className="flex-row items-center gap-2">
                                        <Text className="font-body text-sm text-slate-700 dark:text-slate-300">
                                            Ler mais
                                        </Text>
